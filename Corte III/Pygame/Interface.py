...
class interface:
    def __init__(self):
        ...
        self.pilas_menu = pygame.Rect(460,15,180,40)
...
#Guardar y mostrar los textos
    def all_text(self):
        ...
        PILAS = self.create_text(fuenteSistema,"PILAS")
...
#Dibujar las imagenes en pantalla
    def draw_images(self):
        crab =pygame.image.load("Corte III/Pygame/images/crab.png")
        cat =pygame.image.load("Corte III/Pygame/images/cat.png")
        crocodile =pygame.image.load("Corte III/Pygame/images/crocodile.png")
        dog =pygame.image.load("Corte III/Pygame/images/dog.png")
        sheep =pygame.image.load("Corte III/Pygame/images/sheep.png")
        butterfly =pygame.image.load("Corte III/Pygame/images/butterfly.png")
        whale = pygame.image.load("Corte III/Pygame/images/whale.png")
        logoUAM = pygame.image.load("Corte III/Pygame/images/logoUAM.png")
        logoGit = pygame.image.load("Corte III/Pygame/images/logoGit.png")
        iconLista = pygame.image.load("Corte III/Pygame/images/iconLista.png")
        iconGrafo =  pygame.image.load("Corte III/Pygame/images/iconGrafo.png")
        if self.menu == "SLL":
    ...
    def draw_new_image(self):
        if self.menu=="SLL":
            ...
            for i in range(1,length+1):
                if ( x < 1170):
                    new_image =pygame.image.load(f"Corte III/Pygame/images/{self.SLL.get_node_value(i)}.png")
    ...
    def is_click_menu(self):
        if self.clicking==True:
            if self.sll_menu.collidepoint(pygame.mouse.get_pos()):
                self.menu="SLL"
            if self.pilas_menu.collidepoint(pygame.mouse.get_pos()):
                self.menu="PILAS"
